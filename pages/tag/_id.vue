        ...
        <div class="row justify-content-lg-center">
          <div class="col-md-8">
            ...
            <section class="post-list list-grid list-bordered my-n4">
              <div v-if="postList.length == 0" class="py-4">
                暂无内容
              </div>
...
export default {
  ...
  computed: {
    ...
    ...mapState('tag', ['postList', 'total', 'currentPage'])
  },
  fetch ({ store, query }) {
    store.commit('tag/setCurrentPage', +query.pagenum)
    return store.dispatch('tag/updatePostListActions', {
      tags: query.tags,
      page: query.pagenum,
      per_page: 10,
      _embed: true
  ...
  methods: {
    _changePagination (pagenum) {
      this.$store.commit('tag/setCurrentPage', pagenum)
      this.$router.push({
